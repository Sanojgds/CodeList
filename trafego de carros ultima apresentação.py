...
semaforos = [
    Semaforo(3, 1000, 1000, 250, 110), #semafaro 1
    Semaforo(3, 1000, 1000, 500, 330),
    Semaforo(3, 1000, 1000, 500, 180),
    Semaforo(3, 1000, 1000, 250, 270),
    Semaforo(3, 1000, 1000, 220, 150),
    Semaforo(3, 1000, 1000, 530, 300),
    Semaforo(3, 1000, 1000, 470, 150),
    Semaforo(3, 1000, 1000, 280, 300)
]
